...
dbpf $(PV_PREFIX)1:LOAD:SELECT:G.FLNK $(PV_PREFIX)1:LOAD:SELECT
dbpf $(PV_PREFIX)2:LOAD:SELECT:G.FLNK $(PV_PREFIX)2:LOAD:SELECT
dbpf MAG-SPARE:LOAD:SELECT:G.FLNK MAG-SPARE:LOAD:SELECT

dbpf $(PV_PREFIX)1:REF:FUNC:TYPE:G.SCAN "2 second"
dbpf $(PV_PREFIX)2:REF:FUNC:TYPE:G.SCAN "2 second"
dbpf MAG-SPARE:REF:FUNC:TYPE:G.SCAN "2 second"

dbpf $(PV_PREFIX)1:REF:RUN:G.FLNK $(PV_PREFIX)1:REF:RUN:T
dbpf $(PV_PREFIX)2:REF:RUN:G.FLNK $(PV_PREFIX)2:REF:RUN:T
dbpf MAG-SPARE:REF:RUN:G.FLNK MAG-SPARE:REF:RUN:T
dbpf $(PV_PREFIX)1:REF:ABORT:G.FLNK $(PV_PREFIX)1:REF:ABORT:T
dbpf $(PV_PREFIX)2:REF:ABORT:G.FLNK $(PV_PREFIX)2:REF:ABORT:T
dbpf MAG-SPARE:REF:ABORT:G.FLNK MAG-SPARE:REF:ABORT:T

...
dbpf $(PV_PREFIX)2:REF:VCV:VALUE:S.FLNK $(PV_PREFIX)2:REF:VCV:VALUE:G.PROC
dbpf $(PV_PREFIX)2:REF:BCV:VALUE:S.FLNK $(PV_PREFIX)2:REF:BCV:VALUE:G.PROC
dbpf $(PV_PREFIX)2:REF:CCV:VALUE:S.FLNK $(PV_PREFIX)2:REF:CCV:VALUE:G.PROC
dbpf $(PV_PREFIX)2:REF:PLEP:ACCELERATION:S.FLNK $(PV_PREFIX)2:REF:PLEP:ACCELERATION:G.PROC
dbpf $(PV_PREFIX)2:REF:PLEP:EXP_FINAL:S.FLNK $(PV_PREFIX)2:REF:PLEP:EXP_FINAL:G.PROC
dbpf $(PV_PREFIX)2:REF:PLEP:EXP_TC:S.FLNK $(PV_PREFIX)2:REF:PLEP:EXP_TC:G.PROC
dbpf $(PV_PREFIX)2:REF:PLEP:FINAL:S.FLNK $(PV_PREFIX)2:REF:PLEP:FINAL:G.PROC
dbpf $(PV_PREFIX)2:REF:PLEP:INITIAL:S.FLNK $(PV_PREFIX)2:REF:PLEP:INITIAL:G.PROC
dbpf $(PV_PREFIX)2:REF:PLEP:LINEAR_RATE:S.FLNK $(PV_PREFIX)2:REF:PLEP:LINEAR_RATE:G.PROC
dbpf $(PV_PREFIX)2:REF:PPPL:ACCELERATION1:S.FLNK $(PV_PREFIX)2:REF:PPPL:ACCELERATION1:G.PROC
dbpf $(PV_PREFIX)2:REF:PPPL:ACCELERATION2:S.FLNK $(PV_PREFIX)2:REF:PPPL:ACCELERATION2:G.PROC
dbpf $(PV_PREFIX)2:REF:PPPL:ACCELERATION3:S.FLNK $(PV_PREFIX)2:REF:PPPL:ACCELERATION3:G.PROC
dbpf $(PV_PREFIX)2:REF:PPPL:DURATION4:S.FLNK $(PV_PREFIX)2:REF:PPPL:DURATION4:G.PROC
dbpf $(PV_PREFIX)2:REF:PPPL:INITIAL:S.FLNK $(PV_PREFIX)2:REF:PPPL:INITIAL:G.PROC
dbpf $(PV_PREFIX)2:REF:PPPL:RATE2:S.FLNK $(PV_PREFIX)2:REF:PPPL:RATE2:G.PROC
dbpf $(PV_PREFIX)2:REF:PPPL:RATE4:S.FLNK $(PV_PREFIX)2:REF:PPPL:RATE4:G.PROC
dbpf $(PV_PREFIX)2:REF:PPPL:REF4:S.FLNK $(PV_PREFIX)2:REF:PPPL:REF4:G.PROC
dbpf $(PV_PREFIX)2:REF:RAMP:ACCELERATION:S.FLNK $(PV_PREFIX)2:REF:RAMP:ACCELERATION:G.PROC
dbpf $(PV_PREFIX)2:REF:RAMP:DECELERATION:S.FLNK $(PV_PREFIX)2:REF:RAMP:DECELERATION:G.PROC
dbpf $(PV_PREFIX)2:REF:RAMP:FINAL:S.FLNK $(PV_PREFIX)2:REF:RAMP:FINAL:G.PROC
dbpf $(PV_PREFIX)2:REF:RAMP:INITIAL:S.FLNK $(PV_PREFIX)2:REF:RAMP:INITIAL:G.PROC
dbpf $(PV_PREFIX)2:REF:RAMP:LINEAR_RATE:S.FLNK $(PV_PREFIX)2:REF:RAMP:LINEAR_RATE:G.PROC
dbpf $(PV_PREFIX)2:REF:TEST:AMPLITUDE:S.FLNK $(PV_PREFIX)2:REF:TEST:AMPLITUDE:G.PROC
dbpf $(PV_PREFIX)2:REF:TEST:INITIAL:S.FLNK $(PV_PREFIX)2:REF:TEST:INITIAL:G.PROC
dbpf $(PV_PREFIX)2:REF:TEST:PERIOD:S.FLNK $(PV_PREFIX)2:REF:TEST:PERIOD:G.PROC
dbpf $(PV_PREFIX)2:REF:TRIM:DURATION:S.FLNK $(PV_PREFIX)2:REF:TRIM:DURATION:G.PROC
dbpf $(PV_PREFIX)2:REF:TRIM:FINAL:S.FLNK $(PV_PREFIX)2:REF:TRIM:FINAL:G.PROC
dbpf $(PV_PREFIX)2:REF:TRIM:INITIAL:S.FLNK $(PV_PREFIX)2:REF:TRIM:INITIAL:G.PROC
dbpf $(PV_PREFIX)2:DCCT:SELECT:S.FLNK $(PV_PREFIX)2:DCCT:SELECT:G.PROC
dbpf $(PV_PREFIX)2:MODE:PC_SIMPLIFIED:S.FLNK $(PV_PREFIX)2:MODE:PC_SIMPLIFIED:G.PROC
dbpf $(PV_PREFIX)2:REF:FUNC:REG_MODE:S.FLNK $(PV_PREFIX)2:REF:FUNC:REG_MODE:G.PROC
dbpf $(PV_PREFIX)2:REF:FUNC:TYPE:S.FLNK $(PV_PREFIX)2:REF:FUNC:TYPE:G.PROC
dbpf $(PV_PREFIX)2:REF:TEST:EXP_DECAY:S.FLNK $(PV_PREFIX)2:REF:TEST:EXP_DECAY:G.PROC
dbpf $(PV_PREFIX)2:REF:TEST:WINDOW:S.FLNK $(PV_PREFIX)2:REF:TEST:WINDOW:G.PROC
dbpf $(PV_PREFIX)2:REF:TEST:NUM_PERIODS:S.FLNK $(PV_PREFIX)2:REF:TEST:NUM_PERIODS:G.PROC
...
dbpf $(PV_PREFIX)3:REF:VCV:VALUE:S.FLNK $(PV_PREFIX)3:REF:VCV:VALUE:G.PROC
dbpf $(PV_PREFIX)3:REF:BCV:VALUE:S.FLNK $(PV_PREFIX)3:REF:BCV:VALUE:G.PROC
dbpf $(PV_PREFIX)3:REF:CCV:VALUE:S.FLNK $(PV_PREFIX)3:REF:CCV:VALUE:G.PROC
dbpf $(PV_PREFIX)3:REF:PLEP:ACCELERATION:S.FLNK $(PV_PREFIX)3:REF:PLEP:ACCELERATION:G.PROC
dbpf $(PV_PREFIX)3:REF:PLEP:EXP_FINAL:S.FLNK $(PV_PREFIX)3:REF:PLEP:EXP_FINAL:G.PROC
dbpf $(PV_PREFIX)3:REF:PLEP:EXP_TC:S.FLNK $(PV_PREFIX)3:REF:PLEP:EXP_TC:G.PROC
dbpf $(PV_PREFIX)3:REF:PLEP:FINAL:S.FLNK $(PV_PREFIX)3:REF:PLEP:FINAL:G.PROC
dbpf $(PV_PREFIX)3:REF:PLEP:INITIAL:S.FLNK $(PV_PREFIX)3:REF:PLEP:INITIAL:G.PROC
dbpf $(PV_PREFIX)3:REF:PLEP:LINEAR_RATE:S.FLNK $(PV_PREFIX)3:REF:PLEP:LINEAR_RATE:G.PROC
dbpf $(PV_PREFIX)3:REF:PPPL:ACCELERATION1:S.FLNK $(PV_PREFIX)3:REF:PPPL:ACCELERATION1:G.PROC
dbpf $(PV_PREFIX)3:REF:PPPL:ACCELERATION2:S.FLNK $(PV_PREFIX)3:REF:PPPL:ACCELERATION2:G.PROC
dbpf $(PV_PREFIX)3:REF:PPPL:ACCELERATION3:S.FLNK $(PV_PREFIX)3:REF:PPPL:ACCELERATION3:G.PROC
dbpf $(PV_PREFIX)3:REF:PPPL:DURATION4:S.FLNK $(PV_PREFIX)3:REF:PPPL:DURATION4:G.PROC
dbpf $(PV_PREFIX)3:REF:PPPL:INITIAL:S.FLNK $(PV_PREFIX)3:REF:PPPL:INITIAL:G.PROC
dbpf $(PV_PREFIX)3:REF:PPPL:RATE2:S.FLNK $(PV_PREFIX)3:REF:PPPL:RATE2:G.PROC
dbpf $(PV_PREFIX)3:REF:PPPL:RATE4:S.FLNK $(PV_PREFIX)3:REF:PPPL:RATE4:G.PROC
dbpf $(PV_PREFIX)3:REF:PPPL:REF4:S.FLNK $(PV_PREFIX)3:REF:PPPL:REF4:G.PROC
dbpf $(PV_PREFIX)3:REF:RAMP:ACCELERATION:S.FLNK $(PV_PREFIX)3:REF:RAMP:ACCELERATION:G.PROC
dbpf $(PV_PREFIX)3:REF:RAMP:DECELERATION:S.FLNK $(PV_PREFIX)3:REF:RAMP:DECELERATION:G.PROC
dbpf $(PV_PREFIX)3:REF:RAMP:FINAL:S.FLNK $(PV_PREFIX)3:REF:RAMP:FINAL:G.PROC
dbpf $(PV_PREFIX)3:REF:RAMP:INITIAL:S.FLNK $(PV_PREFIX)3:REF:RAMP:INITIAL:G.PROC
dbpf $(PV_PREFIX)3:REF:RAMP:LINEAR_RATE:S.FLNK $(PV_PREFIX)3:REF:RAMP:LINEAR_RATE:G.PROC
dbpf $(PV_PREFIX)3:REF:TEST:AMPLITUDE:S.FLNK $(PV_PREFIX)3:REF:TEST:AMPLITUDE:G.PROC
dbpf $(PV_PREFIX)3:REF:TEST:INITIAL:S.FLNK $(PV_PREFIX)3:REF:TEST:INITIAL:G.PROC
dbpf $(PV_PREFIX)3:REF:TEST:PERIOD:S.FLNK $(PV_PREFIX)3:REF:TEST:PERIOD:G.PROC
dbpf $(PV_PREFIX)3:REF:TRIM:DURATION:S.FLNK $(PV_PREFIX)3:REF:TRIM:DURATION:G.PROC
dbpf $(PV_PREFIX)3:REF:TRIM:FINAL:S.FLNK $(PV_PREFIX)3:REF:TRIM:FINAL:G.PROC
dbpf $(PV_PREFIX)3:REF:TRIM:INITIAL:S.FLNK $(PV_PREFIX)3:REF:TRIM:INITIAL:G.PROC
dbpf $(PV_PREFIX)3:DCCT:SELECT:S.FLNK $(PV_PREFIX)3:DCCT:SELECT:G.PROC
dbpf $(PV_PREFIX)3:MODE:PC_SIMPLIFIED:S.FLNK $(PV_PREFIX)3:MODE:PC_SIMPLIFIED:G.PROC
dbpf $(PV_PREFIX)3:REF:FUNC:REG_MODE:S.FLNK $(PV_PREFIX)3:REF:FUNC:REG_MODE:G.PROC
dbpf $(PV_PREFIX)3:REF:FUNC:TYPE:S.FLNK $(PV_PREFIX)3:REF:FUNC:TYPE:G.PROC
dbpf $(PV_PREFIX)3:REF:TEST:EXP_DECAY:S.FLNK $(PV_PREFIX)3:REF:TEST:EXP_DECAY:G.PROC
dbpf $(PV_PREFIX)3:REF:TEST:WINDOW:S.FLNK $(PV_PREFIX)3:REF:TEST:WINDOW:G.PROC
dbpf $(PV_PREFIX)3:REF:TEST:NUM_PERIODS:S.FLNK $(PV_PREFIX)3:REF:TEST:NUM_PERIODS:G.PROC

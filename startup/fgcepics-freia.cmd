...
iocInit
dbpf $(PV_PREFIX)1:REF:TABLE:FUNC:VALUE:G.PROC 1
...
dbpf $(PV_PREFIX)1:REF:PLEP:ACCELERATION:G.EGU A/s²
dbpf $(PV_PREFIX)1:REF:PLEP:LINEAR_RATE:S.EGU A/s²
dbpf $(PV_PREFIX)1:REF:PLEP:LINEAR_RATE:G.EGU A/s²
dbpf $(PV_PREFIX)1:REF:PPPL:ACCELERATION1:S.EGU A/s²
dbpf $(PV_PREFIX)1:REF:PPPL:ACCELERATION1:G.EGU A/s²
dbpf $(PV_PREFIX)1:REF:PPPL:ACCELERATION2:S.EGU A/s²
dbpf $(PV_PREFIX)1:REF:PPPL:ACCELERATION2:G.EGU A/s²
dbpf $(PV_PREFIX)1:REF:PPPL:ACCELERATION3:S.EGU A/s²
dbpf $(PV_PREFIX)1:REF:PPPL:ACCELERATION3:G.EGU A/s²
dbpf $(PV_PREFIX)1:REF:RAMP:ACCELERATION:S.EGU A/s²
dbpf $(PV_PREFIX)1:REF:RAMP:ACCELERATION:G.EGU A/s²
dbpf $(PV_PREFIX)1:REF:RAMP:DECELERATION:S.EGU A/s²
dbpf $(PV_PREFIX)1:REF:RAMP:DECELERATION:G.EGU A/s²

dbpf $(PV_PREFIX)2:REF:TABLE:FUNC:VALUE:G.PROC 1
...
dbpf $(PV_PREFIX)2:REF:PLEP:ACCELERATION:G.EGU A/s²
dbpf $(PV_PREFIX)2:REF:PLEP:LINEAR_RATE:S.EGU A/s²
dbpf $(PV_PREFIX)2:REF:PLEP:LINEAR_RATE:G.EGU A/s²
dbpf $(PV_PREFIX)2:REF:PPPL:ACCELERATION1:S.EGU A/s²
dbpf $(PV_PREFIX)2:REF:PPPL:ACCELERATION1:G.EGU A/s²
dbpf $(PV_PREFIX)2:REF:PPPL:ACCELERATION2:S.EGU A/s²
dbpf $(PV_PREFIX)2:REF:PPPL:ACCELERATION2:G.EGU A/s²
dbpf $(PV_PREFIX)2:REF:PPPL:ACCELERATION3:S.EGU A/s²
dbpf $(PV_PREFIX)2:REF:PPPL:ACCELERATION3:G.EGU A/s²
dbpf $(PV_PREFIX)2:REF:RAMP:ACCELERATION:S.EGU A/s²
dbpf $(PV_PREFIX)2:REF:RAMP:ACCELERATION:G.EGU A/s²
dbpf $(PV_PREFIX)2:REF:RAMP:DECELERATION:S.EGU A/s²
dbpf $(PV_PREFIX)2:REF:RAMP:DECELERATION:G.EGU A/s²

dbpf MAG-SPARE:REF:TABLE:FUNC:VALUE:G.PROC 1
...
dbpf MAG-SPARE:REF:PLEP:ACCELERATION:G.EGU A/s²
dbpf MAG-SPARE:REF:PLEP:LINEAR_RATE:S.EGU A/s²
dbpf MAG-SPARE:REF:PLEP:LINEAR_RATE:G.EGU A/s²
dbpf MAG-SPARE:REF:PPPL:ACCELERATION1:S.EGU A/s²
dbpf MAG-SPARE:REF:PPPL:ACCELERATION1:G.EGU A/s²
dbpf MAG-SPARE:REF:PPPL:ACCELERATION2:S.EGU A/s²
dbpf MAG-SPARE:REF:PPPL:ACCELERATION2:G.EGU A/s²
dbpf MAG-SPARE:REF:PPPL:ACCELERATION3:S.EGU A/s²
dbpf MAG-SPARE:REF:PPPL:ACCELERATION3:G.EGU A/s²
dbpf MAG-SPARE:REF:RAMP:ACCELERATION:S.EGU A/s²
dbpf MAG-SPARE:REF:RAMP:ACCELERATION:G.EGU A/s²
dbpf MAG-SPARE:REF:RAMP:DECELERATION:S.EGU A/s²
dbpf MAG-SPARE:REF:RAMP:DECELERATION:G.EGU A/s²

# Force REF:RUN:G update every 5 s

dbpf $(PV_PREFIX)1:REF:RUN:S.SCAN "5 second"
dbpf $(PV_PREFIX)2:REF:RUN:S.SCAN "5 second"
dbpf MAG-SPARE:REF:RUN:S.SCAN "5 second"

// ../../sw/lib/fgceth/fgcepics/fgcudpSup/src/classes/class_63_params.cpp - This file is automatically generated by `parser/Output/EPICS/asynDriver/FGC_handler.pm`  DO NOT EDIT
...
void Class63::create_class_params(asynPortDriver * drv)
{
    ...
    drv->createParam(dev_addr, "ST_DCCT_B"     , asynParamOctet  , &param_id[13]);
    drv->createParam(dev_addr, "I_ERR_MA"      , asynParamInt32  , &param_id[14]);
    drv->createParam(dev_addr, "I_DIFF_MA"     , asynParamInt32  , &param_id[15]);
    drv->createParam(dev_addr, "EVENT_GROUP"   , asynParamInt32  , &param_id[16]);
    drv->createParam(dev_addr, "I_EARTH_PCNT"  , asynParamInt32  , &param_id[17]);
    drv->createParam(dev_addr, "I_REF"         , asynParamFloat64, &param_id[18]);
    drv->createParam(dev_addr, "I_MEAS"        , asynParamFloat64, &param_id[19]);
    drv->createParam(dev_addr, "V_REF"         , asynParamFloat64, &param_id[20]);
    drv->createParam(dev_addr, "V_MEAS"        , asynParamFloat64, &param_id[21]);
};
...
void Class63::update_class_params(asynPortDriver * drv, Pub_data & pub_data)
{
    ...
    drv->setStringParam( dev_addr, param_id[13], mod(st_dcct_b_str));
    drv->setStringParam( dev_addr, param_id[13], st_dcct_b_str);

    drv->setIntegerParam(dev_addr, param_id[14], mod(i_err_ma_int));
    drv->setIntegerParam(dev_addr, param_id[14], i_err_ma_int);

    drv->setIntegerParam(dev_addr, param_id[15], mod(i_diff_ma_int));
    drv->setIntegerParam(dev_addr, param_id[15], i_diff_ma_int);

    drv->setIntegerParam(dev_addr, param_id[16], mod(event_group_int));
    drv->setIntegerParam(dev_addr, param_id[16], event_group_int);

    drv->setIntegerParam(dev_addr, param_id[17], mod(i_earth_pcnt_int));
    drv->setIntegerParam(dev_addr, param_id[17], i_earth_pcnt_int);

    drv->setDoubleParam( dev_addr, param_id[18], mod(i_ref_float));
    drv->setDoubleParam( dev_addr, param_id[18], i_ref_float);

    drv->setDoubleParam( dev_addr, param_id[19], mod(i_meas_float));
    drv->setDoubleParam( dev_addr, param_id[19], i_meas_float);

    drv->setDoubleParam( dev_addr, param_id[20], mod(v_ref_float));
    drv->setDoubleParam( dev_addr, param_id[20], v_ref_float);

    drv->setDoubleParam( dev_addr, param_id[21], mod(v_meas_float));
    drv->setDoubleParam( dev_addr, param_id[21], v_meas_float);
...
// End of file: ../../sw/lib/fgceth/fgcepics/fgcudpSup/src/classes/class_63_params.cpp
